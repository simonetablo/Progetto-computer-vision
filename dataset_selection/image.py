...
def plot(num):    
    ...
    query=pd.read_csv('./dataset_selection/selected_query.csv')
    ...
    string='/media/simone/Giochi/dataset/2015-08-13-16-02-58/2015-08-13-16-02-58_stereo_centre_0'+str(burstq[0])+'/2015-08-13-16-02-58/stereo/centre/'+str(timestampsq[0])+'.png'
    pic6=load_image(string)
    string='/media/simone/Giochi/dataset/2015-08-13-16-02-58/2015-08-13-16-02-58_stereo_centre_0'+str(burstq[1])+'/2015-08-13-16-02-58/stereo/centre/'+str(timestampsq[1])+'.png'
    pic7=load_image(string)
    string='/media/simone/Giochi/dataset/2015-08-13-16-02-58/2015-08-13-16-02-58_stereo_centre_0'+str(burstq[2])+'/2015-08-13-16-02-58/stereo/centre/'+str(timestampsq[2])+'.png'
    pic8=load_image(string)
    string='/media/simone/Giochi/dataset/2015-08-13-16-02-58/2015-08-13-16-02-58_stereo_centre_0'+str(burstq[3])+'/2015-08-13-16-02-58/stereo/centre/'+str(timestampsq[3])+'.png'
    pic9=load_image(string)
    string='/media/simone/Giochi/dataset/2015-08-13-16-02-58/2015-08-13-16-02-58_stereo_centre_0'+str(burstq[4])+'/2015-08-13-16-02-58/stereo/centre/'+str(timestampsq[4])+'.png'
